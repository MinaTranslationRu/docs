...
The full Mina GraphQL schema is available [here](https://minaprotocol.com/graphql-docs/index.html).
...
To retrieve the details of an account for the primary mina [token](https://minaprotocol.com/docs/architecture/tokens):
...
Consult the [GraphQL schema](https://minaprotocol.com/graphql-docs/mutation.doc.html) for all available mutations.
...
A GraphQL [subscription](https://minaprotocol.com/graphql-docs/subscription.doc.html) allows a GraphQL client to have data pushed to it when an event occurs. In Mina, there are subscriptions for:
...
- [Public GraphQL proxy](http://graphql.o1test.net/graphql)

...
Давайте рассмотрим пару примеров, которые продемонстрируют реальную силу Snapps.
...
- Пользователь посещает другой веб-сайт, который запрашивает идентификацию личности. Он может поделиться доказательством ID вместе с хэшем своего ID, чтобы доказать, что его адрес Мина претендует на подлинность ID.
